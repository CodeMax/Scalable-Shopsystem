package de.hm.shop.shippment.rest.filter;
...
@Component
@Provider
public class ShippmentLoginFilter implements ContainerRequestFilter {

	/** Logger dieser Klasse. */
	private static final Logger LOG = LoggerFactory.getLogger(ShippmentLoginFilter.class);
