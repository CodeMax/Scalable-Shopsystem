package de.hm.shop.article.rest.filter;
...
@Component
@Provider
public class ArticleLoginFilter implements ContainerRequestFilter {

	/** Logger dieser Klasse. */
	private static final Logger LOG = LoggerFactory.getLogger(ArticleLoginFilter.class);
