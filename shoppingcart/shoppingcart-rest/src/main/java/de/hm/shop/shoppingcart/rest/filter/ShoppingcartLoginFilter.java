package de.hm.shop.shoppingcart.rest.filter;
...
@Component
@Provider
public class ShoppingcartLoginFilter implements ContainerRequestFilter {

	/** Logger dieser Klasse. */
	private static final Logger LOG = LoggerFactory.getLogger(ShoppingcartLoginFilter.class);
