...
var createArticle_component_1 = require('./createArticle.component');
var TestComponent = (function () {
    function TestComponent() {
    }
    TestComponent = __decorate([
        core_1.Component({
            directives: [createArticle_component_1.CreateArticleComponent]
        }), 
        __metadata('design:paramtypes', [])
    ], TestComponent);
    return TestComponent;
}());
testing_1.describe('CreateArticleComponent', function () {
...
//# sourceMappingURL=createArticle.component.spec.js.map