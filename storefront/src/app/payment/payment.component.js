...
var PaymentComponent = (function () {
    function PaymentComponent(_http, _loginService, _tokenService, _router, jwtHelper) {
        this._http = _http;
        this._loginService = _loginService;
        this._tokenService = _tokenService;
        this._router = _router;
        this.jwtHelper = jwtHelper;
        this.paymentList = new payment_service_1.List();
    ...
    PaymentComponent.prototype.getPaymentMethodsForArticles = function (article) {
        ...
        new backendcall_service_1.BackendcallService(this._http, 'token', this._tokenService.getToken(), 'http://192.168.99.100:8086/payments/' + article.supplierId)
            .getPayment().subscribe(function (data) { return _this.paymentList.add(data); }, function (error) { return _this.handleError(error); }, function () { return console.log('Get all Items complete'); });
    };
    ...
    PaymentComponent = __decorate([
        ...
        __metadata('design:paramtypes', [http_1.Http, login_service_1.LoginService, token_service_1.TokenService, router_1.Router, angular2_jwt_1.JwtHelper])
    ], PaymentComponent);
